      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {status === 'success' && (
          <div className="bg-amber-50 border border-amber-200 text-amber-700 text-sm p-3 rounded-lg flex items-center gap-2">
            <span>⏳ Pending moderator review</span>
            <span className="text-xs">Expected timeline: 24-48 hours</span>
          </div>
        )}

        {/* Submit Button */}
        <div className="flex gap-3 pt-4">
          <PolymathButton type="submit" variant="primary" size="lg" isFullWidth disabled={status === 'loading'}>
